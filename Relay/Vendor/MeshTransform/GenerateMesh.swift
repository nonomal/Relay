//
//  GenerateMesh.swift
//  Relay — vendored verbatim from Telegram-iOS (GPL-2.0)
//
//  Source: submodules/TelegramUI/Components/MeshTransform/Sources/GenerateMesh.swift
//
//  Builds the displacement mesh for the glass edge: a signed-distance field over a
//  rounded rect, sampled along a tuned bezier so vertices bunch up near the border and
//  push outward — the geometry behind Telegram's edge refraction.
//
